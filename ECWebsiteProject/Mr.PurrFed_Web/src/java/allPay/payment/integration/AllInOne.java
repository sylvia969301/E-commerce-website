	...
	public String aioCheckOut(Object obj, InvoiceObj invoice){
		...
		if(obj instanceof AioCheckOutALL){
			...
			if(ignorePayment.length > 0){
                                System.out.println("ignorePayment = " + Arrays.toString(ignorePayment));
				...
				ignoreParam = ignoreParam.substring(1, ignoreParam.length()-1);
                                System.out.println("ignoreParam = " + ignoreParam);
				((AioCheckOutALL) obj).setIgnorePayment("WebATM#ATM#CVS#Tenpay#TopUpUsed#APPBARCODE");
			}
